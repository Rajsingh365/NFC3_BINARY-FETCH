...
//   const [selectedSection, setSelectedSection] = useState("Game Preference & Skills");
...
//         <form action="http://localhost:5000/api/uploads/upload-cover" method="post" encType="multipart/form-data">
